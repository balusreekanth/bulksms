            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <!-- <div class="btn-group">
                  ...
                  <table id="devtab" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>Sender Number</th>
                        <th>Provider</th>
                    ...
                    <?php if(isset($inbox)){foreach ($inbox as $row) {?>
                      <tr>
                        ...
                        <td><?php echo $rdate = $my_date = date('d-m-Y H:i', strtotime($row['ReceivingDateTime']));?></td>
                        <td><button id="<?php echo $row['ID'];?>" class="btn btn-warning delete">Delete</button></td>
                      </tr>
